export const home = {
  ko: {
    ...
    toast: {
      ...
      plansLoadFailedOffline: "오프라인 상태이며 저장된 여행 계획이 없습니다. 온라인 상태에서 한 번 열어본 뒤 다시 시도해주세요.",
      plansLoadFailed: "여행 계획을 불러오지 못했습니다. 잠시 후 다시 시도해주세요.",
  ...
  en: {
    ...
    toast: {
      ...
      plansLoadFailedOffline: "You're offline and no trip plans are cached yet. Open this once while online, then try again.",
      plansLoadFailed: "Couldn't load your trip plans. Please try again shortly.",
