            ...
            packages.map((pkg) => {
              ...
              return (
                <button
                  ...
                  disabled={payingId !== null}
                  className={`relative w-full flex items-center justify-between gap-3 p-4 rounded-xl text-left bg-card border ${theme.border} shadow-sm hover:shadow-md transition-all disabled:opacity-50`}
                >
                  {theme.badge && (
